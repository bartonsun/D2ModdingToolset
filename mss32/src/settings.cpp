...
static void readSettings(const sol::table& table, Settings& settings)
{
    ...
    settings.minimapShowImpassableObjects = readSetting(table, "minimapShowImpassableObjects", defaultGameSettings().minimapShowImpassableObjects);
...
const Settings& baseGameSettings()
{
    ...
    if (!initialized) {
        ...
        settings.minimapShowImpassableObjects = true;
