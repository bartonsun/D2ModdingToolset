...
static std::array<Functions, 4> functions = {{
    ...
    Functions{
        ...
        (StratInterfGetPhaseGame)0x059852F,
        (CPhaseGameIsClientsTurn)0x0406394,
    ...
    Functions{
        ...
        (StratInterfGetPhaseGame)0x044FCB1,
        (CPhaseGameIsClientsTurn)0x0406020,
    ...
    Functions{
        ...
        (StratInterfGetPhaseGame)0x0542B1E, 
        (CPhaseGameIsClientsTurn)nullptr,
