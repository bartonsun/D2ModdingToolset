...
std::array<Api, 3> functions = {{
    ...
    Api{
        ...
        (Api::SwitchToMenu)0x4eb068,
        (Api::SwitchToMenu)0x4eafcf,
        (Api::SwitchToMenuQuickLoad)0x4eaf3f,
        (Api::ShowTransitionToMain)0x4ead41,
        (Api::ShowTransitionToMainOrCloseGame)0x4eacf1,
        (Api::SetId)0x4ebb97,
        (Api::SetId)0x4ebb72,
    ...
    Api{
        ...
        (Api::SwitchToMenu)0x4ea51a,
        (Api::SwitchToMenu)0x4ea481,
        (Api::SwitchToMenuQuickLoad)0x4ea3f1,
        (Api::ShowTransitionToMain)0x4ea1f3,
        (Api::ShowTransitionToMainOrCloseGame)0x4ea1a3,
        (Api::SetId)0x4eb050,
        (Api::SetId)0x4eb02b,
